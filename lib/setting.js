...
var KEYS = [KEY_TEAM, KEY_CHASE, KEY_ACCEPTED,
        ...
        KEY_SHOW_PROBLEM_DETAIL, KEY_FORCE_NEW_TAG, KEY_RANDOM_ORDER, KEY_OUTPUT_PATH];
...
function getDefaultSetting() {
    ...
    setting[KEY_SHOW_PROBLEM_DETAIL] = [
        PROBLEM_DETAIL_KEY_TITLE,
        PROBLEM_DETAIL_KEY_SOLVED,
        PROBLEM_DETAIL_KEY_TAG,
        PROBLEM_DETAIL_KEY_URL
    ];
    setting[KEY_FORCE_NEW_TAG] = false;
    setting[KEY_RANDOM_ORDER] = false;
...
exports.Setting = function () {
    ...
    setting.isShowProblemUrl = function () {
        return setting[KEY_SHOW_PROBLEM_DETAIL].indexOf(PROBLEM_DETAIL_KEY_URL) !== -1;
    };
    ...
    setting.isRandomOrder = function () {
        return setting[KEY_RANDOM_ORDER];
    };
